...
export default function MonitorTab({ solarData, localData, vfcData, reports, history, logSymptom }) {
  ...
  return (
    <View>
      ...
      <View style={styles.synthesisCard}><Text style={styles.cardTitle}>Diagnóstico Fase 4</Text><Text style={styles.synthesisText}>{vfcData.status !== "Sincronizado" ? "⚠️ La VFC cae (VVAs/VVDs de Halberg). El Sistema Nervioso Simpático está activo." : "✅ VFC estable. Cronosfera biológica alineada."}</Text></View>
    </View>
  );
}
