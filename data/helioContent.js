...
export default function HelioContent() {
  return (
    <View>
      ...
      <View style={styles.card}><Text style={styles.h2}>Franz Halberg (19ing9-2013)</Text><Text style={styles.bodyText}>Padre de la Cronobiología. Descubrió que la biología está sincronizada con ciclos del entorno (ritmos multiseptanos, trans-anuales). Llamó a esto la "Cronosfera". Sus estudios ligaron arritmias cardíacas y muertes súbitas con ciclos de 1.3 años del magnetismo solar.</Text></View>
      <View style={styles.card}><Text style={styles.h2}>De Marginales a Centrales</Text><Text style={styles.bodyText}>Bajo la Cuarta Ley, estas ciencias son el núcleo de la física: demuestran que el ser humano es un nodo acoplado a los ritmos del cosmos, actuando como una estructura disipativa.</Text></View>
    </View>
  );
}
