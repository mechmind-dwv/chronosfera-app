...
export default function ManifestoContent() {
  return (
    <View>
      ...
      <View style={styles.card}><Text style={styles.h2}>De la Marginalidad al Centro</Text><Text style={styles.bodyText}>Si aceptamos la Cuarta Ley, la vida es una cualidad física inevitable. Somos estructuras disipativas cuyo propósito es degradar gradientes de energía(3).</Text></View>
      <View style={styles.card}><Text style={styles.h2}>Ecuación Fundamental</Text><Text style={styles.bodyText}>σ = Σ(Ji * Xi) ≥ 0. Traducimos la complejidad ambiental en un índice comprensible que cruza datos cósmicos (Kp), locales (σ) y fisiológicos (VFC).</Text></View>
      <View style={styles.card}><Text style={styles.h2}>Linaje Científico y Agradecimientos</Text><Text style={style={styles.bodyText}>Este software no sería posible sin Alexander L. Chizhevsky, Franz Halberg, Vladimir Vernadsky, Ilya Prigogine y Mikhail N. Zhadin.</Text></View>
